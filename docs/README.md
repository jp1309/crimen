...
|---|---|---|
| [Automatización](AUTOMATIZACION.md) | Horario, responsabilidades y recreación de la tarea mensual de Codex | Al cambiar de equipo, horario o responsable |
...
- Automatización local vigente: configuración de la tarea de Codex `actualizar-dashboard-de-homicidios`.
